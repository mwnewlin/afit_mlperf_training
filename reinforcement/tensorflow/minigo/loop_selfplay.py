...
def main_():
    ...
    while count_games() < MAX_GAMES_PER_GENERATION:
        ...
        print('selfplaying: {:.2f} games/hour'.format(games /
                                                      ((time.time() - start_t) / 60 / 60)))
    ...
    sys.stdout.flush()
    while count_games() > MAX_GAMES_PER_GENERATION:
        print('Too many selfplay games ({}/{}) ... deleting one'.format(count_games(),
                                                                        MAX_GAMES_PER_GENERATION))
        ...
        time.sleep(1)
    print('After cleanup, there are {} games in the selfplay directory at {}'.format(
        count_games(), selfplay_dir))
    sys.stdout.flush()
