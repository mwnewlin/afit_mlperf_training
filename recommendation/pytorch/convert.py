...
def main():
    ...
    for row in tqdm(df.itertuples(), desc='Ratings', total=len(df),disable=args.progress_bar):
    ...
    for user in tqdm(range(len(original_users)), desc='Users', total=len(original_users),disable=args.progress_bar):  # noqa: E501
