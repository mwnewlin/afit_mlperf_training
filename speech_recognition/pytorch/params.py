...
# minimum noise level to sample from (1.0 means all noise and no original signal)
noise_min = 0.0
# maximum noise level to sample from (1.0 means all noise and no original signal)
noise_max = 0.5
...
# relative path to train manifest is download_dataset is used
train_manifest = '../libri_train_manifest.csv'
# relative path to val manifest is download_dataset is used
